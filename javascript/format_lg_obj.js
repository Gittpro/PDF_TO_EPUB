...
!function($) {
    ...
    function setupEquations(){
        ...
        // if there's mathjax, then wait for it and render equations and tables after mathjax is done
        if (window.MathJax != undefined) {
            MathJax.Hub.Queue(function() {
                ...
                for (var i = 0; i < Equations.length; i++) {
        		    ...
        		    if (equation.childNodes && equation.childNodes[0]) {
    ...
    function scaleIt(it){
        if(it.id != "highlightPopupContent"){
            ...
            if(itW > parentW){
                ...
                var oheight = it.offsetHeight/.96,
                    height = oheight,
                    parentHeight = it.parentNode.offsetHeight
